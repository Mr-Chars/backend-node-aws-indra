import { handler } from "../src/adapters/controllers/appointmentPeController"
...
describe('appointmentPeController', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        require('../src/application/handlers/appointmentPeHandler').handleSQSEvent = mockHandleSQSEvent;
    });
