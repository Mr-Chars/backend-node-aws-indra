import { handler } from "../src/adapters/controllers/appointmentClController"
...
describe('appointmentClController', () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        require('../src/application/handlers/appointmentClHandler').handleSQSEvent = mockHandleSQSEvent;
    });
