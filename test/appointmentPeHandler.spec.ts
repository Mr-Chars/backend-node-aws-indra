...
import { handleSQSEvent } from "../src/application/handlers/appointmentPeHandler";

jest.mock('../src/application/services/appointmentPe.service');
...
describe('appointmentPeHandler', () => {
    ...
    beforeEach(() => {
        ...
        // Configurar mock para AppointmentPeService
        mockCreate = jest.fn().mockResolvedValue(undefined);
        (AppointmentPeService as jest.Mock).mockImplementation(() => ({
            create: mockCreate
        }));
